/**
 * PATTERN FUNCTION PANEL - Simplified UI
...
export const PatternFunctionPanel: React.FC<PatternFunctionPanelProps> = ({
  grid,
  allTiles,
  onGridUpdate,
  gridWidth = 12,
...
// Default export for compatibility with page.tsx
export default PatternFunctionPanel;